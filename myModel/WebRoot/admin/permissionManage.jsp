				...
				<table class="search_table">
					<tbody>
						<tr>
							...
							<td>
								<label><a href="javascript:;" id="subSearch" class="button w_70 color01">搜索</a></label>
								<label class="ml_10"><a href="javascript:;" id="resourceAdd" class="button w_70">资源新增</a></label>
							</td>
						</tr>
					</tbody>
				</table>
								...
								<tr>
									...
									<td>
										<s:if test="#bean.status == 0">
											<a href="javascript:;" class="button w_50 color02">删除</a>
										</s:if>
									</td>
								</tr>
							</s:iterator>
	...
	<div id="addBox" style="display: none;">
		<table style="width: 340px;text-align: center;" class="resource_add">
			...
			<tbody>
				...
				<tr><td colspan="2"><a href="javascript:;" class="button w_50 color04" onclick="addResource()">确定</a></td></tr>
